...
[`pass_filter.py`](https://github.com/victoria-fuller/HDGC_WGS_2025/blob/main/Python/Structural%20variant%20pipeline/pass_filter.py) : Filters variants that do not pass technical filter from Manta  
