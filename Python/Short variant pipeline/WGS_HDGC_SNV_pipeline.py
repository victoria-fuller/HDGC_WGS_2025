...
Last Modified 13/11/2025, 20/11/2025

Description: 
Retreives file path from output file to automate filtering pipeline with optional scrips

Usage:
python3 <WGS_HDGC_SNV_pipeline.py> --pipeline <pipeline> --vcf_input <vcf_file> --gene_list <gene_list> --biomart_file <biomart_file> --flank_bp <flank_bp>
