...
# Script Name:
# 2_filter_proband.sh
# Description: Filter combined structural VCF file to include only variants present in the proband
...
# Run: bash 2_filter_proband.sh <vcf file path> 

set -euo pipefail

# Define the current step for file names
previous_step="combine_sv"
