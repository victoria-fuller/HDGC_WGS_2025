...
# Description: Filters to keep variants in or near to CDH1 or CTNNA1 or genes physically interacting with them

# How to run:
# Log in to CYNAPSE using magic link
# Start interactive session
# Mount joint_germline_recalibrated_VEP.ann.vcf.gz annotated vcf into session data
# Run: bash 6_optional_filter_genes.sh <vcf file path>
...
echo "Filtering for variants interacting with CDH1 or CTNNA1..."
